...
<%@ page import="com.technoetic.xplanner.domain.UserStory"%>
...
<table class="objecttable currentStatus" id="currentStatus">
	<thead>
	  <tr>
      <th colspan="2" title='<bean:message key="iteration.labeltooltip.current_status"/>'><bean:message key="iteration.label.current_status"/></th>
    </tr>
    <tr>  
      <th>&nbsp;</th>
...
<table id="<%= IterationAccuracyPage.ITERATION_STATUS_TABLE_ID %>" class="objecttable status">
  <thead>
	  <tr>
	    <th colspan="3" title='<bean:message key="iteration.labeltooltip.summary"/>'><bean:message key="iteration.label.summary"/></th>
	  </tr>
	  <tr>
	    <th>&nbsp;</th>
