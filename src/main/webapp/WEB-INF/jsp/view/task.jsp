...
<db:useBean id="task" type="com.technoetic.xplanner.domain.Task" scope="request"/>
...
<table id="time_entries" class="objecttable" cellpadding="1">
  ...
  <tbody>
   ...
   <logic:iterate name="entries" scope="page" id="entry" indexId="n"
                  type="com.technoetic.xplanner.domain.TimeEntry">
      <tr>
        ...
        <td nowrap>
            <logic:notEqual name="entry" property="person1Id" value="0">
                <db:useBean
                    id="person1" type="com.technoetic.xplanner.domain.Person"
            ...
            <logic:notEqual name="entry" property="person2Id" value="0">
                <db:useBean
                    id="person2" type="com.technoetic.xplanner.domain.Person"
        ...
        <td nowrap align="left" <logic:empty name="entry" property="description">"bgcolor='#f0f0f0'"</logic:empty>>
...
<jsp:include page="exportLinks.jsp"/>
 <xplanner:link page="/do/view/history">
    ...
    <xplanner:linkParam id='<%= AbstractAction.TYPE_KEY %>' value='<%= task.getClass().getName() %>'/>
 </xplanner:link>
</tiles:put>
