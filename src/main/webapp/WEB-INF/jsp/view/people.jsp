...
<%@ page import="com.technoetic.xplanner.security.SecurityHelper,
                 ...
                 com.technoetic.xplanner.domain.Person,
                 java.util.*"%>
...
<xplanner:isUserAuthorized permission="admin.hide" resourceType="system.person"  >
    <db:useBeans id="people" type="com.technoetic.xplanner.domain.Person" order="is_hidden,name asc"/>
...
%>
                        <xplanner:link styleClass="image" page='<%=action.getTargetPage()%>' paramId="oid"
                            ...
                            <html:img page='<%=action.getIconPath()%>' alt='<%=action.getName()%>' border="0"/>
                        </xplanner:link>
                    <% } %>
                    &nbsp;
