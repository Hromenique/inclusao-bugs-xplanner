...
<%@ page import="com.technoetic.xplanner.format.DecimalFormat,
                 ...
                 com.technoetic.xplanner.domain.UserStory,
                 com.technoetic.xplanner.XPlannerProperties, org.apache.struts.action.ActionMessages, org.apache.struts.action.ActionErrors"%>
...
<db:useBean id="iteration" type="com.technoetic.xplanner.domain.Iteration" scope="request" />
...
<xplanner:writableTable defaultsort="3"  defaultorder="ascending" name="requestScope.iteration" id="objecttable"
    ...
    <bean:define id="story" name="objecttable" type="com.technoetic.xplanner.domain.UserStory"/>
    <%
...
<%--DEBT: Remove duplication. Everything in the actionButtons should be extracted --%>
    ...
    <dt:column sortable="true" sortProperty="customer.name" title='<%= messages.getMessage("stories.tableheading.customer")%>'>
        <logic:notEmpty name="story" property="customer">
                <bean:define id="customer" name="story" property="customer" type="com.technoetic.xplanner.domain.Person" />
...
<%--    </dt:column>--%>
    ...
    <dt:column sortable="true" sortProperty="trackerName" align="center" title='<%= messages.getMessage("stories.tableheading.tracker")%>'>
		    <logic:notEqual name="story" property="trackerId" value="0">
				<db:useBean id="tracker" type="com.technoetic.xplanner.domain.Person"
    ...
    <dt:column align="center" sortable="true" title='<%= messages.getMessage("stories.tableheading.status")%>'>
        <%=messages.getMessage(story.getStatus().getNameKey())%>
    </dt:column>
