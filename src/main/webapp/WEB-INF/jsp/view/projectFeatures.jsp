...
<xplanner:isUserAuthorizedForAny name="project" property="iterations" permissions="edit,delete">
    ...
    <logic:iterate name="project" property="iterations" id="iteration" type="com.technoetic.xplanner.domain.Iteration">
        <logic:iterate name="iteration" property="userStories" id="story" type="com.technoetic.xplanner.domain.UserStory">
