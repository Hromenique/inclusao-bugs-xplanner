  ...
  <thead>
	 ...
	 <tbody>
	  <logic:iterate collection='<%= tasks %>'  id="currentTask"
				    type="com.technoetic.xplanner.domain.Task">
         ...
         <db:useBean id="task" oid='<%= new Integer(currentTask.getId()) %>'
            type="com.technoetic.xplanner.domain.Task"/>
	     <db:useBean id="story" oid='<%= new Integer(task.getStory().getId()) %>'
			type="com.technoetic.xplanner.domain.UserStory"/>
		 <db:useBean id="iteration" oid='<%= new Integer(story.getIterationId()) %>'
			type="com.technoetic.xplanner.domain.Iteration"/>
