...
<xplanner:content>
  <bean:define id="iteration" name="edit/iteration" type="com.technoetic.xplanner.domain.Iteration" />
...
<xplanner:navigation oid='<%= iteration.getId() %>'
	type="com.technoetic.xplanner.domain.Iteration" inclusive="true"/>
