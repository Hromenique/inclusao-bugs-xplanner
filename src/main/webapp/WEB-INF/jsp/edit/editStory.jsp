...
<logic:present parameter="oid">
    ...
    <tiles:put name="objectType">com.technoetic.xplanner.domain.UserStory</tiles:put>
</logic:present>
<logic:notPresent parameter="oid">
    ...
    <tiles:put name="objectType">com.technoetic.xplanner.domain.Iteration</tiles:put>
</logic:notPresent>
        ...
        <b><bean:message key="story.editor.estimated_hours"/> </b>
			...
			<td>
				...
				<logic:equal name="story" property="taskBasedEstimatedHours" value="0">
				    <div class="borderedInput"><div><html:text name="story" property='<%=UserStory.TASK_BASED_ESTIMATED_HOURS%>' size="5"/></div></div>
				</logic:equal>
      </td>
	  </tr>
	  <tr>
