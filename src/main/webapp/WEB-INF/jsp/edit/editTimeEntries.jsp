...
<tiles:put name="objectType">com.technoetic.xplanner.domain.Task</tiles:put>
...
<div id="editObject" style="width:100%;">
  ...
  <table>
    ...
    <tr>
      ...
      <th nowrap><bean:message key="timelog.editor.duration"/></th>
      ...
      <th><bean:message key="timelog.editor.person2"/></th>
      <th><bean:message key="timelog.editor.description"/></th>
      <th><html:img page="/images/delete.gif" alt="delete" border="0"/></th>
    </tr>
    </thead>
   <%
   ...
   %>
    <tr>
      <td class="objecttable" <%= entries.isIntervalReadOnly(row) ? "bgcolor='#f0f0f0'" : "" %>>
