...
<xplanner:content>
<bean:define id="task" name="edit/task" type="com.technoetic.xplanner.domain.Task" />
...
<xplanner:navigation oid='<%= task.getId() %>'
	type="com.technoetic.xplanner.domain.Task" inclusive="true"/>
</logic:present>
<logic:notPresent parameter="oid">
<xplanner:navigation oid='<%= Integer.parseInt(request.getParameter("fkey")) %>'
	type="com.technoetic.xplanner.domain.UserStory" inclusive="true"/>
</logic:notPresent>
