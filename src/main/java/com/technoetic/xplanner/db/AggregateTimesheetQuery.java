        ...
        try {
            try {
                query =
                        ...
                        "FROM Person as person, Project as project,elements(project.iterations) as iteration, " +
                        "elements(iteration.userStories) as story, elements(story.tasks) as task, elements(task.timeEntries) as time_entry " +
