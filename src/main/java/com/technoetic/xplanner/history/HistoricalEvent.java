...
public class HistoricalEvent implements Identifiable{
   ...
   //For hibernate
    ...
    public HistoricalEvent(int containerId, int targetObjectId, String objectType, String action, String description,
    ...
    public String toString(){
        return "HistoricalEvent(id="+this.getId()+
   ...
   public boolean equals(Object o) {
      ...
      final HistoricalEvent event = (HistoricalEvent) o;
