...
public class ContinueUnfinishedStoriesAction extends EditObjectAction {
   ...
   private void continueIteration(int currentIterationId,
      ...
      Iteration originalIteration = (Iteration) getRepository(Iteration.class).load(currentIterationId);
      Iteration targetIteration = (Iteration) getRepository(Iteration.class).load(targetIterationId);
