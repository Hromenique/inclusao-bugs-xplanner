...
public class EventManager implements ApplicationContextAware {
	...
	public void publishUpdateEvent(ActionForm actionForm, DomainObject domainObject, Person editor) {
		ApplicationEvent event = new ObjectUpdated(actionForm, new EventSource(domainObject, editor));
		applicationContext.publishEvent(event);
	}
	
	public void publishCreateEvent(DomainObject domainObject, Person editor){
