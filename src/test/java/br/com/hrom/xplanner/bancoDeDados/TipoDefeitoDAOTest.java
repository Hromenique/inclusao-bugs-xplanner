...
public class TipoDefeitoDAOTest extends AbstractDAOTest<TipoDefeitoDAO, TipoDefeito>{
	...
	protected List<TipoDefeito> populaListaEntidades() {
		...
		lista.add(new TipoDefeito(1l, "Requisitos", true));
		lista.add(new TipoDefeito(2l, "Análise", true));
		lista.add(new TipoDefeito(3l, "Codificação", true));
	...
	protected TipoDefeito criaEntidadeDefault() {
		return new TipoDefeito(1l, "Requisitos", true);
	}
