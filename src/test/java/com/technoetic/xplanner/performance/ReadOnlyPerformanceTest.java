...
public class ReadOnlyPerformanceTest extends AbstractPageTestScript {
    ...
    public void showHistoryPages() {
        tester.gotoPage("/do/view/history?oid=1&@type=com.technoetic.xplanner.domain.Project");
        tester.gotoPage(
            "/do/view/history?oid=76742&@type=com.technoetic.xplanner.domain.Iteration");
        tester.gotoPage("/do/view/history?oid=4747&@type=com.technoetic.xplanner.domain.UserStory");
        tester.gotoPage("/do/view/history?oid=804&@type=com.technoetic.xplanner.domain.Task");
    }
