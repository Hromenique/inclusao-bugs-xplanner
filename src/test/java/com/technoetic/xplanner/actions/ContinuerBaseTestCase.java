...
public abstract class ContinuerBaseTestCase extends AbstractUnitTestCase {
   ...
   private double initialPostponedHours = 4.0;
   ...
   protected void setUpTasksStoryAndIteration() throws HibernateException, RepositoryException {
      ...
      incompleteTask1.setStory(story);
      incompleteTask2.setStory(story);
      completedTask.setStory(story);
   ...
   protected ObjectRepository createMockObjectRepository() {
      return new ObjectRepository() {
         ...
         public int insert(DomainObject object) {
            return 0;
         }
   ...
   protected void verifyContinuedStory(UserStory continuedStory) {
      assertEquals("iteration ID", 6666, continuedStory.getIterationId());
      ...
      for (Iterator iterator = allSavedTasks.iterator(); iterator.hasNext();) {
         ...
         if (task.getStory().getId() == continuedStory.getId()) {
...
//        assertEquals("# of features", 2, features.size());
      ...
      assertSame("story", continuedStory, task.getStory());
   ...
   protected void createNotesListFor(DomainObject attachedToObject) {
      ...
      file.setData(new BlobImpl("data".getBytes()));
   ...
   protected void assertHistoricalEventInObject(DomainObject object, String description, String eventType) {
      support.assertHistoricalEventInObject(object.getId(),
                                            eventType,
                                            description,
