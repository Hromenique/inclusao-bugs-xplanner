...
import com.technoetic.xplanner.soap.*;
...
public abstract class AbstractSoapTestCase extends AbstractDatabaseTestScript {
    ...
    private SoapAdapterEqualAssert anAssert = new SoapAdapterEqualAssert();
...
//            newFeature(story);
            ...
            addedIteration.setStatus(IterationStatus.ACTIVE);
