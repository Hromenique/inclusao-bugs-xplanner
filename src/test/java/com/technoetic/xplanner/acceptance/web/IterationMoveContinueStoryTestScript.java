...
public class IterationMoveContinueStoryTestScript extends AbstractPageTestScript {
   ...
   private String testStoryNameForMoveTest = "Test story name";
   ...
   private String estimatedHours = "23.5";
  ...
  private void assertStoryOrder(String storyId, int expectedOrder) {
    ...
    assertEquals("story " + storyId + " order ", String.valueOf(expectedOrder), actualOrder);
  }
...
//        tester.assertOptionNotListed("targetIterationId", testProjectName + " :: " + fromIterationName);
   ...
   public void testMoveStoryToDifferentIteration() throws Exception {
      ...
      verifyHistoricalEvents(HistoricalEvent.MOVED_OUT, fromStoryName);
      ...
      verifyTargetIterationHistory(HistoricalEvent.MOVED_IN, fromStoryName);
   ...
   public void testContinueStoryInDifferentIteration() throws Exception {
      ...
      verifyHistoricalEvents(HistoricalEvent.CONTINUED, fromStoryName + " in iteration: " + testIterationName);
      gotoIteration(testIterationName);
      tester.assertTextPresent(fromStoryName);
      ...
      gotoIteration(testIterationName);
      verifyHistoricalEvents(HistoricalEvent.CONTINUED, fromStoryName + " in iteration: " + fromIterationName);
      verifyTargetIterationHistory(HistoricalEvent.CONTINUED, fromStoryName);
   }
   ...
   private void assertContinuingStoryDisposition(IterationStatus targetIterationStatus,
      ...
      toIteration.setStatus(targetIterationStatus);
   ...
   private void setUpToIteration() throws Exception {
      ...
      toStory.setEstimatedHours(Double.parseDouble(estimatedHours));
...
//       testTaskId = tester.addTask(testTaskName, developerName, testTaskDescription, testTaskEstimatedHours);
   ...
   private void verifyMovedStoryHistory() throws Exception {
      gotoIteration(testIterationName);
      tester.clickLinkWithText(fromStoryName);
      verifyHistoricalEvents(HistoricalEvent.MOVED, "from " + fromIterationName + " to " + testIterationName);
   }

   private void verifyTargetIterationHistory(String eventType, String description) throws Exception {
      gotoIteration(testIterationName);
      verifyHistoricalEvents(eventType, description);
   }

   private void verifyHistoricalEvents(String eventType, String description) {
