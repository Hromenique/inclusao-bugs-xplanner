...
public class TestRepositoryHistoryAdapter extends AbstractUnitTestCase {
   ...
   public void testInsertHistory() throws Exception {
      ...
      checkSaveHistory(domainObject, HistoricalEvent.CREATED, null, XPlannerTestSupport.DEFAULT_PERSON_ID);
      replay();
   ...
   public void testUpdateHistory() throws Exception {
      ...
      checkSaveHistory(domainObject, HistoricalEvent.UPDATED, null, XPlannerTestSupport.DEFAULT_PERSON_ID);
      replay();
   ...
   private void checkSaveHistory(DomainObject domainObject, String evenType, String description, int personId) {
