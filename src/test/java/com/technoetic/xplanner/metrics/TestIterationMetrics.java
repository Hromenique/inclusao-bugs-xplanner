...
public class TestIterationMetrics extends TestCase{
    ...
    private String PERSON1_NAME = "name1";
    private String PERSON2_NAME = "name2";
    ...
    private Collection createListOfTasks() {
    ...
    private class FakeIterationMetrics extends IterationMetrics {
        private Iteration noHoursIteration;

        public FakeIterationMetrics(Iteration iteration) {
            FakeIterationMetrics.this.noHoursIteration = iteration;
        }
