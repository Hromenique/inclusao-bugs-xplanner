...
public class TestPrincipalSpecificPermissionHelper extends TestCase {
   ...
   public void testAddPersonPermissions() throws Exception {
      Map projectSpecificPersonPermissionMap = new HashMap();
      projectSpecificPersonPermissionMap.put(new Integer(1), Arrays.asList(new Object[]{permission1}));
      projectSpecificPersonPermissionMap.put(new Integer(2), Arrays.asList(new Object[]{permission2}));
