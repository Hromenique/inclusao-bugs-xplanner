...
public class TestAuthorizerImpl extends AbstractUnitTestCase {
   ...
   public void testSimplePermissionMatch() throws Exception {
      ...
      results.put(new Integer(PRINCIPAL_ID),
                  Arrays.asList(new Object[]{createPositivePermission("system", resourceId, "set")}));
      expect(
   ...
   public void testSimplePermissionNonmatch() throws Exception {
      ...
      results.put(new Integer(PRINCIPAL_ID),
                  Arrays.asList(new Object[]{createPositivePermission("system.project",
   ...
   public void testGetPeopleWithPermissionOnProject() throws Exception {
      ...
      Map<Integer,List<Object>> results1 = new HashMap<Integer,List<Object>>();
      Map<Integer,List<Object>> results2 = new HashMap<Integer,List<Object>>();
      results1.put(new Integer(project1Id),
                   Arrays.asList(new Object[]{createPositivePermission("system.project", project1Id, "edit")}));
      results2.put(new Integer(project2Id),
                   Arrays.asList(new Object[]{createPositivePermission("system.project", project2Id, "edit")}));
      expect(
